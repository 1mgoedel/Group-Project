...
CREATE TABLE `movies_on_list` (
  ...
  KEY `fk_users_has_movies_movies2_idx` (`movie_id`),
  KEY `fk_users_has_movies_users2_idx` (`user_id`),
  CONSTRAINT `fk_users_has_movies_movies2` FOREIGN KEY (`movie_id`) REFERENCES `movies` (`id`),
  CONSTRAINT `fk_users_has_movies_users2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
